...
#     new_quaternion.w = rotation.w
#     new_quaternion.x = -rotation.x
#     new_quaternion.y = rotation.z
#     new_quaternion.z = -rotation.y
...
def realworld_translation(position):
    return np.array([-position[1], position[0], position[2]])


def realworld_rotation(rotation):
    new_quaternion = quaternion.quaternion()
    new_quaternion.w = rotation.w
    new_quaternion.x = rotation.x
    new_quaternion.y = rotation.y
    new_quaternion.z = -rotation.z
    return new_quaternion
